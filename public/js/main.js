...
var _injectedHTML = __webpack_require__(26);
...
var _handleButton$handleConfirm$handleCancel = __webpack_require__(24);

var _handleKeyDown = __webpack_require__(25);
...
var _setParameters = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__App_vue__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__App_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__App_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__routes_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_resource__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__packages_auth_Auth_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vee_validate__ = __webpack_require__(28);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_4__packages_auth_Auth_js__["a" /* default */]);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.http.interceptors.push(function (request, next) {
    next(function (response) {
        if (response.status == 404) swal(response.status.toString(), response.body.error, "error");else if (response.status == 500) swal(response.status.toString(), "Everything is very bad, we are working on this", "error");
    });
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Navbar_vue__ = __webpack_require__(30);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        if (this.isAuth) this.setAuthenticatedUser();
    },
        ...
        update: function update() {
            ...
            this.$validator.validateAll().then(function (result) {
                if (result) {
                    ...
                    _this2.$http.put('/api/profile/' + data.id, data).then(function (response) {
        ...
        register: function register() {
            ...
            this.$validator.validateAll().then(function (result) {
                if (result) {
                    ...
                    _this.$http.post('api/register/', data).then(function (response) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert__ = __webpack_require__(7);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.$http.get('/api/coordinates/').then(function (response) {
            _this.coordinates = response.body;
        });
    },


    methods: {
        deleteCoordinates: function deleteCoordinates(coordinate) {
            __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()({
                ...
                this.$http.delete('/api/coordinates/' + coordinate.id).then(function (response) {
                    var index = _this2.coordinates.indexOf(coordinate);

                    _this2.coordinates.splice(index, 1);

                    __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()("Deleted!", "Your coordinates has been deleted.", "success");
                });
            }.bind(this));
        }
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        create: function create() {
            ...
            this.$validator.validateAll().then(function (result) {
                if (result) {
                    var data = { coordinates: _this.coordinates };
                    _this.$http.post('http://dinarys.dev/api/coordinates', data).then(function (response) {
                        _this.$router.push('/coordinates');
                    });
                }
            });
        }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getCoordinates: function getCoordinates() {
            ...
            this.$http.get('/api/coordinates/' + this.$route.params.coordinates).then(function (response) {
                _this.coordinates = response.body.coordinates;
            });
        },
        update: function update() {
            var _this2 = this;
            ...
            this.$validator.validateAll().then(function (result) {
                if (result) {
                    var data = { coordinates: _this2.coordinates };
                    _this2.$http.put('/api/coordinates/' + _this2.$route.params.coordinates, data).then(function (response) {
                        __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()("Updated", "Yor coordinates has been updated", "success");
                    });
                }
            });
        }
...
Component.options.__file = "E:\\Projects\\dinarys\\resources\\assets\\js\\App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-05601dc4", Component.options)
  } else {
    hotAPI.reload("data-v-05601dc4", Component.options)
  }
...
Component.options.__file = "E:\\Projects\\dinarys\\resources\\assets\\js\\components\\Navbar.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-78b55c68", Component.options)
  } else {
    hotAPI.reload("data-v-78b55c68", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "E:\\Projects\\dinarys\\resources\\assets\\js\\components\\Personal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0b058afc", Component.options)
  } else {
    hotAPI.reload("data-v-0b058afc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "E:\\Projects\\dinarys\\resources\\assets\\js\\components\\authentication\\Login.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-117d22e4", Component.options)
  } else {
    hotAPI.reload("data-v-117d22e4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "E:\\Projects\\dinarys\\resources\\assets\\js\\components\\authentication\\Register.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-25b1778e", Component.options)
  } else {
    hotAPI.reload("data-v-25b1778e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "E:\\Projects\\dinarys\\resources\\assets\\js\\components\\coordinates\\CoordinatesList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] CoordinatesList.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-47d5f6ce", Component.options)
  } else {
    hotAPI.reload("data-v-47d5f6ce", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "E:\\Projects\\dinarys\\resources\\assets\\js\\components\\coordinates\\CreateCoordinate.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] CreateCoordinate.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-09ddabe4", Component.options)
  } else {
    hotAPI.reload("data-v-09ddabe4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "E:\\Projects\\dinarys\\resources\\assets\\js\\components\\coordinates\\EditCoordinate.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] EditCoordinate.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6e381672", Component.options)
  } else {
    hotAPI.reload("data-v-6e381672", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-05601dc4", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("Add New Coordinate")]), _vm._v(" "), _c('div', {
  ...
  }, [_c('label', [_vm._v("Coordinates")]), _vm._v(" "), _c('textarea', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.errors.has('coordinates')),
      expression: "errors.has('coordinates')"
    }],
    staticClass: "help-block alert alert-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('coordinates')))])]), _vm._v(" "), _c('input', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-09ddabe4", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0b058afc", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-117d22e4", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-25b1778e", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "row"
  }, [_c('h2', [_vm._v("Coordinates List")]), _vm._v(" "), _c('router-link', {
    staticClass: "btn btn-primary",
    attrs: {
      "to": "/coordinates/create"
    }
  }, [_vm._v("\n        + Add Coordinates\n    ")]), _vm._v(" "), _c('hr'), _vm._v(" "), _c('table', {
    staticClass: "table table-hover table-bordered"
  }, [_vm._m(0), _vm._v(" "), _c('tbody', _vm._l((_vm.coordinates), function(coordinate) {
    return _c('tr', [_c('td', [_vm._v(_vm._s(coordinate.coordinates))]), _vm._v(" "), _c('td', [_c('router-link', {
      staticClass: "btn btn-primary",
      attrs: {
        "to": '/coordinates/' + coordinate.id + '/edit'
      }
    }, [_vm._v("\n                        Edit\n                    ")]), _vm._v(" "), _c('button', {
      staticClass: "btn btn-danger",
      on: {
        "click": function($event) {
          _vm.deleteCoordinates(coordinate)
        }
      }
    }, [_vm._v("Delete")])], 1)])
  }))])], 1)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Coordinates")]), _vm._v(" "), _c('th', [_vm._v("Actions")])])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-47d5f6ce", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "form-group"
  }, [_c('label', [_vm._v("Coordinates")]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.errors.has('coordinates')),
    ...
    staticClass: "help-block alert alert-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('coordinates')))]), _vm._v(" "), _c('textarea', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.coordinates),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6e381672", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('a', [_vm._v("Main")])]), _vm._v(" "), (!_vm.isAuth) ? _c('router-link', {
    attrs: {
      "tag": "li",
      "to": "/login"
    }
  }, [_c('a', [_vm._v("Login")])]) : _vm._e(), _vm._v(" "), (!_vm.isAuth) ? _c('router-link', {
    attrs: {
      "tag": "li",
      "to": "/register"
    }
  }, [_c('a', [_vm._v("Register")])]) : _vm._e(), _vm._v(" "), (_vm.isAuth) ? _c('router-link', {
    attrs: {
      "tag": "li",
      "to": "/coordinates"
    }
  }, [_c('a', [_vm._v("Coordinates")])]) : _vm._e(), _vm._v(" "), (_vm.isAuth) ? _c('router-link', {
    attrs: {
      "tag": "li",
      "to": "/personal"
    }
  }, [_c('a', [_vm._v("Personal")])]) : _vm._e(), _vm._v(" "), (_vm.isAuth) ? _c('li', [_c('a', {
    attrs: {
      "href": "#"
    },
    on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-78b55c68", module.exports)
  }
}
...
var update = __webpack_require__(5)("75e37029", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-05601dc4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-05601dc4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("2f6c848c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-09ddabe4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CreateCoordinate.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-09ddabe4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CreateCoordinate.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("0f2c02fa", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0b058afc\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Personal.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0b058afc\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Personal.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("2b2bd339", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6e381672\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EditCoordinate.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6e381672\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EditCoordinate.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
Component.options.__file = "E:\\Projects\\dinarys\\resources\\assets\\js\\components\\Main.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-47d6b7f5", Component.options)
  } else {
    hotAPI.reload("data-v-47d6b7f5", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h3', [_vm._v("Привет, меня зовут Роман"), _c('br'), _c('small', [_c('i', [_vm._v("и я ищу работу")])])]), _vm._v(" "), _c('p', [_vm._v("Это мое тестовое задание в одну из компаний. Задачей было следующее:")]), _vm._v(" "), _c('p', [_vm._v("Реализовать REST API клиент работы с серверной частью.\n            Создание SPA для регистрации, авторизации, редактирования пользователя. Внесения наборов измерений. Просмотра набора измерений и вычислений наборов с максимальным периметром.")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-47d6b7f5", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("49da798e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-47d6b7f5\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Main.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-47d6b7f5\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Main.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
